...
# Produce a Human-readable Table of Country Contiguity
...
# Put Instrumental Variables into a table
...
# tab_instr_100_x2 <- get_tab_instrument(threshold = 100, closest_n = 2)
...
tab_instr <- tab_instr_0 %>% merge(tab_instr_50, by = "country") %>% merge(tab_instr_100, by = "country")
write.csv(tab_instr, "a5 instrument.csv", na = "", row.names = F)
